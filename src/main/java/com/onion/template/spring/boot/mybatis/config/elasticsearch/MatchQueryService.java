package com.onion.template.spring.boot.mybatis.config.elasticsearch;

/**
 * @ClassName MatchQueryService
 * @Description: TODO 匹配查询(match)
 * @Author onion
 * @Date 2020/8/3
 * @Version V1.0
 **/
import com.alibaba.fastjson.JSON;
import com.onion.template.spring.boot.mybatis.config.elasticsearch.model.UserInfo;
